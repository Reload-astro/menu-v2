...
function library:CreateSettingsTab(menu)
    ...
    local function refreshConfigs()
        ...
        for _, v in next, listfiles(self.cheatname..'/'..self.gamename..'/configs') do
            ...
            if filename and v:sub(-#self.fileext) == self.fileext then
                library.options.selectedconfig:AddValue(filename)
            end
        end
    end    
    ...
    table.insert(themeStrings, "Custom")
...
return librarylocal startupArgs = ({...})[1] or {}
